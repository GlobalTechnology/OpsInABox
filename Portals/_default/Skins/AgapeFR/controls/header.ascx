...
<div id="bar1" class="centeredbox bar menuclosed">
    ...
    <div id="menu">
        ...
        <div id="menubuttons">
            ...
            <asp:HyperLink ID="userIconLink" CssClass="userIconLink" runat="server">
