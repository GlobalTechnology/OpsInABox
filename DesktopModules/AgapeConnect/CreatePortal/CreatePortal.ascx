...
Country Name: <asp:TextBox ID="tbCountryName" runat="server"></asp:TextBox><br />
Country ISO code: <asp:TextBox ID="tbCountryISOCode" runat="server"></asp:TextBox><br />
Currency Symbol: <asp:TextBox ID="tbCurrencySymbol" runat="server"></asp:TextBox><br />
Dataserver URL <i>(optional)</i>: <asp:TextBox ID="tbDataServer" runat="server"></asp:TextBox> eg 'https://tntdataserver.eu/dataserver/mat/' <br />
Advances Suffix <i>(optional)</i>: <asp:TextBox ID="tbAdvancesSuffix" runat="server"></asp:TextBox> eg 'Advances' <br />
Accounting Currency: 
...
<asp:ListItem Value="ZWD">Zimbabwe Dollar</asp:ListItem>
                ...
                </asp:DropDownList> (usually the same)<br />
Company: <asp:TextBox ID="tbCompany" runat="server"></asp:TextBox> <br />

AutoGenerate Users (From TnT)?: <asp:CheckBox ID="cbGenerateUsers" runat="server" /><br />

Admin TheKey Username: <asp:TextBox ID="tbAdminEmail" runat="server"></asp:TextBox>  <br />
Admin Firstname: <asp:TextBox ID="tbAdminFirstname" runat="server"></asp:TextBox>  <br />
Admin Lastname: <asp:TextBox ID="tbAdminLastname" runat="server"></asp:TextBox>  <br />
...
<asp:Button ID="btnTest" runat="server" Text="Test Button (Caution)" /> <br />
