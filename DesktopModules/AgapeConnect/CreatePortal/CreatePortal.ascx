<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CreatePortal.ascx.vb" Inherits="DotNetNuke.Modules.AgapeConnect.CreatePortal" %>
...
<div class="form-horizontal">
    <div class="control-group">
        <label class="control-label" for="tbCountryName">Country Name:</label>
        <div class="controls">
            <asp:TextBox ID="tbCountryName" runat="server" placeholder="Country Name"></asp:TextBox>

        </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="tbCountryISOCode"> Country/Minsitry code:</label>
        <div class="controls ">
            <span class="span5">
             <asp:TextBox ID="tbCountryISOCode" runat="server" placeholder="Country/Ministry Code" ></asp:TextBox></span>
             <span class="alert " >*used to create the XXX.agapeconnect.me url. </span>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="tbCurrencySymbol"> Currency Symbol:</label>
        <div class="controls">
              <span class="span5">
            <asp:TextBox ID="tbCurrencySymbol" runat="server" placeholder="Currency Symbol (eg. '$')"></asp:TextBox></span>
             <span class="alert">*should match the Accounting Currency</span>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="tbDataServer"> Dataserver URL:</label>
        <div class="controls">
              <span class="span5">
            <asp:TextBox ID="tbDataServer" runat="server" Width="320px" placeholder="eg. https://tntdataserver.com/dataserver/mkd/"></asp:TextBox></span>
             <span class="alert">*optional</span>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="ddlAccountingCurrency">  Accounting Currency: </label>
        <div class="controls">
    ...
    <asp:DropDownList ID="ddlAccountingCurrency" runat="server" class="ddlCur">
        ...
        <asp:ListItem Value="RSD">Serbian Dinar</asp:ListItem>
    ...
    <div class="control-group">
        <label class="control-label" for="ddlLocalCurrency">  Local Currency: </label>
        <div class="controls">
             <span class="span5">
    <asp:DropDownList ID="ddlLocalCurrency" runat="server" class="ddlCur">
        ...
        <asp:ListItem Value="ZWD">Zimbabwe Dollar</asp:ListItem>
               ...
               <span class="alert">*usually the same as Accounting Currency. </span>
        </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="tbAdminEmail"> Admin TheKey Username:</label>
        <div class="controls">
            <asp:TextBox ID="tbAdminEmail" runat="server" type="email" placeholder="Admin Email"></asp:TextBox>
         
        </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="tbAdminFirstname">Admin Firstname:</label>
        <div class="controls">
            <asp:TextBox ID="tbAdminFirstname" runat="server" placeholder="First Name"></asp:TextBox>

        </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="tbAdminLastname">Admin Lastname:</label>
        <div class="controls">
            <asp:TextBox ID="tbAdminLastname" runat="server" placeholder="Last Name"></asp:TextBox>
     ...
     <div class="control-group">
    <div class="controls">
         <asp:Button ID="btnCreate" runat="server" Text="Create" class="btn"/>
   ...
   <%-- Advances Suffix <i>(optional)</i>:
    <asp:TextBox ID="tbAdvancesSuffix" runat="server"></asp:TextBox>
    eg 'Advances'
    <br />
    ...
    AutoGenerate Users (From TnT)?:
    <asp:CheckBox ID="cbGenerateUsers" runat="server" /><br />--%>

   
   

<%--
    <asp:Button ID="btnTest" runat="server" Text="Test Button (Caution)" />
    <br />

    <asp:Button ID="btnFCX" runat="server" Text="FCX Test" />

    <asp:Button ID="btnCreateAllUsers" runat="server" Text="CreateAllUsers" />

    <asp:Button ID="btnproxy" runat="server" Text="Proxy Text" />

    <asp:Button ID="btnCreateEntropy" runat="server" Text="btnCreateEntropy" />--%>
