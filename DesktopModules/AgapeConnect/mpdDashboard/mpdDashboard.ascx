...
<div id="pnlMain" runat="server">
    ...
    <uc1:mpdDashboardMenu runat="server" ID="mpdDashboardMenu" Mode="Countries"/>
        ...
        <asp:Repeater ID="rpCountriesSummaryData" runat="server">
            <ItemTemplate>
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# EditUrl("countryDashboard") & "?country=" & Eval("ISO")%>'>
                    ...
                    <tr class="countryRow">
                        <th>
                            <asp:HiddenField ID="hfISO" runat="server" Value='<%# Eval("ISO")%>' />
                            <asp:Label ID="lblCountryName" runat="server" Text='<%# Eval("Name") %>'></asp:Label></th>
                        <td>
                            <asp:Label ID="lblSupYear" runat="server" Text='<%# Eval("Year") %>'></asp:Label></td>
                        <td>
                            <asp:Label ID="lblBud" runat="server" Text='<%# Eval("Budget") %>'></asp:Label></td>

                        <td>
                            <asp:Label ID="lblSupQuart" runat="server" Text='<%# Eval("less50")%>'></asp:Label></td>
                        <td>
                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("from50to80")%>'></asp:Label></td>
                        <td>
                            <asp:Label ID="Label2" runat="server" Text='<%# Eval("from80to100")%>'></asp:Label></td>
                        <td>
                            <asp:Label ID="Label3" runat="server" Text='<%# Eval("more100")%>'></asp:Label></td>
                        <td>
                            <asp:Label ID="lblSupMonth" runat="server" Text='<%# Eval("BudgetSpent")%>'></asp:Label></td>

                        <td>
                            <asp:Label ID="lblAccuracy" runat="server" Text='<%# Eval("Local") %>'></asp:Label></td>
