<%@ Control Language="C#" AutoEventWireup="false" Explicit="true" Inherits="DotNetNuke.Modules.AgapeFR.SearchResults.ResultsSettings" CodeFile="ResultsSettings.ascx.cs" %>
