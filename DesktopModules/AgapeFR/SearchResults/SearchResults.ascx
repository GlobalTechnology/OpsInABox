<%@ Control Language="C#" AutoEventWireup="false" Inherits="DotNetNuke.Modules.AgapeFR.SearchResults.SearchResults" CodeFile="SearchResults.ascx.cs" %>
...
<div class="dnnSearchResultPanel" style="display:none;">
    <div class="dnnRight">
...
<div id="dnnSearchResultAdvancedForm" class="dnnForm" style="display:none;">
    ...
    $(function () {
        if(typeof dnn != 'undefined' && dnn.searchResult){
            ...
            dnn.searchResult.queryOptions = {
                searchTerm: '<%= String.IsNullOrEmpty(SearchTerm)?"":SearchTerm.Replace("\'", "\\\'") %>',
                sortOption: 0,
                pageIndex: 1,
                pageSize: 15
            };
