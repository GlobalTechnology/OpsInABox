...
<table>
    ...
    <tr>
      ...
      <tr>
        <td><b><dnn:label id="lblDescription" runat="server" controlname="Description"  resourcekey="lblDescription"  /></b></td>
        <td>
            <dnn:TextEditor ID="Description" runat="server" Height="300" Width="650"  />
        </td>
    </tr>
    <tr>
